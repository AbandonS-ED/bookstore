...
.welcome-icon {
  ...
  font-size: 2.2rem;
  margin-bottom: 24px;
  box-shadow: 0 8px 32px rgba(192, 154, 75, 0.25);
...
.sc-icon { font-size: 1.2rem; margin-bottom: 8px; display: block; }
.sc-title { font-family: var(--font-display, 'Noto Serif SC', serif); font-size: 0.85rem; font-weight: 600; color: var(--color-text); margin-bottom: 3px; }
.sc-desc { font-size: 0.76rem; color: var(--color-text-light, #9B8B7E); line-height: 1.5; }
...
@media (max-width: 768px) {
  ...
  .welcome-icon { width: 64px; height: 64px; font-size: 1.8rem; border-radius: 16px; }
