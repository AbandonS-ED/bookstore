...
CREATE TABLE `community_post` (
    ...
    `image_url` MEDIUMTEXT COMMENT '图片URL',
...
('尤瓦尔·赫拉利', '尤瓦尔·赫拉利（Yuval Noah Harari），以色列历史学家，牛津大学博士，耶路撒冷希伯来大学历史系教授。', '以色列', '1976—', NULL),
('史铁生', '史铁生，中国当代作家、散文家。双腿瘫痪后，他在病榻上书写了对生命最深刻的思考。', '中国', '1951—2010', '鲁迅文学奖'),
('周岭', '周岭，中国个人成长领域作家，专注于认知科学和自我改变的研究。', '中国', NULL, NULL);
...
('978-7-0200-4379-0', '人类简史', '尤瓦尔·赫拉利', '中信出版社', 68.00, 88.00, 100, 0, 0, 5, '从人类过去到未来，赫拉利为我们描绘了一幅令人震撼的未来图景。', NULL, '历史没有正义，只有演化。'),
('978-7-0200-4380-6', '我与地坛', '史铁生', '人民文学出版社', 36.00, 45.00, 80, 0, 0, 1, '史铁生的经典散文集，关于生命、苦难与希望的沉思。', NULL, '死是一件不必急于求成的事。'),
('978-7-0200-4381-3', '认知觉醒', '周岭', '人民邮电出版社', 49.80, 65.00, 60, 0, 0, 3, '关于自我改变的底层逻辑，开启自我改变的原动力。', NULL, '人与人之间的根本差异是认知能力上的差异。');
...
UPDATE `book` SET `description` = '尤瓦尔·赫拉利的全球畅销之作，从认知革命、农业革命到科学革命，讲述了人类从百万年前的非洲草原到现代社会的完整演化历程。赫拉利以宏大的叙事视角和跨学科的知识广度，重新审视了人类文明的每一个关键节点。\n\n书中最令人震撼的观点之一是：智人之所以能够统治地球，关键不在于个体智慧，而在于大规模灵活合作的能力——而这种能力的核心就是"讲故事"。金钱、国家、法律、公司，全都是人类共同想象的虚构故事。\n\n★ 全球销量超过1600万册\n★ 比尔·盖茨、扎克伯格推荐阅读\n★ 被翻译成60多种语言' WHERE `isbn` = '978-7-0200-4379-0';

UPDATE `book` SET `description` = '史铁生最经典的散文集，收录了《我与地坛》《合欢树》《秋天的怀念》等多篇感人至深的作品。双腿瘫痪后，史铁生在荒芜的地坛中找到了与命运和解的方式，用文字与生命对话。\n\n他写母亲："她心里太苦了，上帝看她受不住了，就召她回去。"他写生死："死是一件不必急于求成的事，死是一个必然会降临的节日。"他用平静而深邃的文字，将苦难化为对生命最温柔的拥抱。\n\n★ 感动无数读者的生命之书\n★ 中国当代散文的巅峰之作\n★ 入选中学语文教材' WHERE `isbn` = '978-7-0200-4380-6';

UPDATE `book` SET `description` = '周岭的自我改变指南，一本关于如何真正"觉醒"的实用之书。作者从大脑构造、元认知、专注力、学习力、行动力、情绪力等多个维度，揭示了人与人之间差距产生的根本原因——认知能力上的差异。\n\n书中提出"焦虑的本质是想要与能力不匹配""真正的成长是耐心和坚持""深度学习是普通人逆袭的唯一捷径"等观点，配合大量可操作的方法论，帮助读者打破认知局限，开启自我改变的原动力。\n\n★ 连续多周占据畅销榜前列\n★ 被众多读书博主推荐为"改变人生的书"\n★ 豆瓣评分8.6，口碑极佳的个人成长读物' WHERE `isbn` = '978-7-0200-4381-3';
...
UPDATE `book` SET `publish_date` = '2026-05-15' WHERE `isbn` = '978-7-0200-4379-0';
UPDATE `book` SET `publish_date` = '2026-05-15' WHERE `isbn` = '978-7-0200-4380-6';
UPDATE `book` SET `publish_date` = '2026-05-15' WHERE `isbn` = '978-7-0200-4381-3';
...
(100, 2, '林小雅', '读完《瓦尔登湖》，决定开始极简生活', 'https://picsum.photos/seed/walden/400/500', 128, 0, NULL),
(101, 2, '书虫阿东', '深夜推理时间，《白夜行》太绝了', 'https://picsum.photos/seed/whiteNight/400/300', 89, 0, 11),
(102, 2, '雨落江南', '诗集读完了，整个人都安静下来', 'https://picsum.photos/seed/poetry/400/600', 256, 0, 6),
(103, 2, '北漂青年', '打工人的日常，地铁上读完半本《活着》', 'https://picsum.photos/seed/toLive/400/350', 67, 0, 4),
(104, 2, '文艺大叔', '三体让我对宇宙充满敬畏', 'https://picsum.photos/seed/threeBody/400/450', 312, 0, 3),
(105, 2, '小红迷', '月下看《围城》，方渐鸿的无奈', 'https://picsum.photos/seed/fortress/400/400', 178, 0, 9),
(106, 2, '阅读者', '人类简史刷新了我的认知边界', 'https://picsum.photos/seed/sapiens/400/550', 234, 0, 31),
(107, 2, '书语者', '我与地坛的文字让我泪流满面', 'https://picsum.photos/seed/ditian/400/320', 445, 0, 32),
(108, 2, '墨染白', '边城的翠翠，那条溪水清澈如她的眼眸', 'https://picsum.photos/seed/biancheng/400/480', 189, 0, 16),
(109, 2, '星河书社', '认知觉醒，让我开始真正思考', 'https://picsum.photos/seed/awaken/400/380', 156, 0, 33),
(110, 2, '豆瓣用户', '百年孤独里的魔幻现实让人着迷', 'https://picsum.photos/seed/century/400/520', 278, 0, 5),
...
((SELECT `id` FROM `book` WHERE `isbn` = '978-7-0200-4379-0'), '历史没有正义，只有演化。', 1),
((SELECT `id` FROM `book` WHERE `isbn` = '978-7-0200-4379-0'), '我们之所以研究历史，不是为了要知道未来，而是要拓宽视野，了解现在的种种绝非自然，也并非无可避免。', 2),
