...
-- 插入测试书籍
INSERT INTO `book` (`isbn`, `title`, `author`, `publisher`, `price`, `orig_price`, `stock`, `sales`, `category_id`, `description`, `cover_url`, `quote`) VALUES
('978-7-111-54742-2', 'Java核心技术卷I', '凯·S·霍斯特曼', '机械工业出版社', 119.00, 149.00, 100, 3200, 3, 'Java技术经典参考书', '/pictures/Java核心技术.jpg', '历史在重演，科学的发展也不过是重演前代的思想。'),
('978-7-115-42835-7', 'Python编程：从入门到实践', '埃里克·马瑟斯', '人民邮电出版社', 79.00, 99.00, 80, 5600, 3, 'Python入门经典', '/pictures/python编程.jpg', '代码是写给人读的，顺便让机器执行。'),
('978-7-5322-5000-2', '三体', '刘慈欣', '重庆出版社', 68.00, 88.00, 50, 12800, 2, '科幻巨著，中国科幻文学里程碑', '/pictures/三体.jpg', '给岁月以文明，而不是给文明以岁月。'),
('978-7-5443-7010-3', '活着', '余华', '作家出版社', 35.00, 45.00, 60, 9800, 1, '当代经典小说，讲述生命的韧性', '/pictures/活着.jpg', '人是为活着本身而活着，而不是为了活着之外的任何事物所活着。'),
('978-7-5443-5012-9', '百年孤独', '加西亚·马尔克斯', '南海出版公司', 55.00, 69.00, 120, 22000, 1, '魔幻现实主义经典之作', '/pictures/百年孤独.jpg', '过去都是假的，回忆是一条没有归途的路。'),
('978-7-5402-3412-8', '小王子', '安托万·德·圣-埃克苏佩里', '人民文学出版社', 28.00, NULL, 200, 25000, 1, '写给成年人的童话', '/pictures/小王子.jpg', '重要的东西用眼睛是看不见的，要用心去感受。'),
('978-7-101-04013-5', '红楼梦', '曹雪芹', '中华书局', 98.00, 128.00, 80, 18500, 1, '中国古典四大名著之首', '/pictures/红楼梦.jpg', '满纸荒唐言，一把辛酸泪。'),
('978-7-5442-4531-9', '挪威的森林', '村上春树', '上海译文出版社', 38.00, NULL, 90, 16000, 1, '村上春树代表作，青春爱情小说', '/pictures/挪威的森林.jpg', '每个人都有属于自己的一片森林，也许我们从来不曾去过。'),
('978-7-80173-502-3', '围城', '钱钟书', '人民文学出版社', 39.00, 49.00, 70, 14000, 1, '中国现代文学经典', '/pictures/围城.jpg', '婚姻是一座围城，城外的人想进去，城里的人想出来。'),
('978-7-5302-1753-5', '平凡的世界', '路遥', '北京十月文艺出版社', 79.00, 99.00, 150, 35000, 1, '茅盾文学奖获奖作品', '/pictures/平凡的世界.jpg', '生活不能等待别人来安排，要自己去争取和奋斗。'),
('978-7-5354-5422-5', '白夜行', '东野圭吾', '南海出版公司', 45.00, 58.00, 85, 19000, 1, '东野圭吾悬疑推理巅峰之作', '/pictures/白夜行.jpg', '世上有两样东西不可直视，一是太阳，二是人心。'),
('978-7-5402-3612-2', '月亮与六便士', '毛姆', '人民文学出版社', 42.00, 55.00, 75, 13000, 1, '关于理想与现实的经典之作', '/pictures/月亮与六便士.jpg', '满地都是六便士，他却抬头看见了月亮。'),
('978-7-5402-3411-1', '人间失格', '太宰治', '人民文学出版社', 32.00, NULL, 65, 11000, 1, '太宰治半自传体小说', '/pictures/人间失格.jpg', '生而为人，我很抱歉。'),
('978-7-5354-5423-2', '解忧杂货店', '东野圭吾', '南海出版公司', 42.00, 52.00, 110, 28000, 1, '温暖人心的奇幻治愈小说', '/pictures/解忧杂货店.jpg', '人的心声是绝对不能无视的。'),
('978-7-5442-4532-6', '追风筝的人', '卡勒德·胡赛尼', '上海译文出版社', 36.00, NULL, 95, 24000, 1, '关于赎罪的感人故事', '/pictures/追风筝的人.jpg', '为你，千千万万遍。'),
('978-7-5302-1754-2', '边城', '沈从文', '北京十月文艺出版社', 29.00, 38.00, 55, 6000, 1, '中国乡土文学经典', '/pictures/边城.jpg', '凡事都有偶然的凑巧，结果却又如宿命的必然。'),
('978-7-5402-3613-9', '骆驼祥子', '老舍', '人民文学出版社', 30.00, NULL, 60, 7500, 1, '老舍代表作，底层人民的生活写照', '/pictures/骆驼祥子.jpg', '钱会把人引进恶劣的社会中去，把高尚的理想撇开。'),
('978-7-101-04014-2', '呐喊', '鲁迅', '中华书局', 32.00, 42.00, 70, 9000, 1, '中国现代文学奠基之作', '/pictures/呐喊.jpg', '希望是本无所谓有，无所谓无的。'),
('978-7-5302-1755-9', '家', '巴金', '北京十月文艺出版社', 35.00, NULL, 50, 5500, 1, '巴金代表作，激流三部曲之一', '/pictures/家.jpg', '青春是美丽的，但一个人的青春可以平庸无奇。'),
('978-7-5402-3614-6', '茶馆', '老舍', '人民文学出版社', 28.00, NULL, 45, 4800, 1, '中国话剧经典', '/pictures/茶馆.jpg', '改良改良，越改越凉。'),
('978-7-5402-3615-3', '雷雨', '曹禺', '人民文学出版社', 32.00, 42.00, 55, 6500, 1, '中国话剧史上的里程碑', '/pictures/雷雨.jpg', '一切都是命中注定，谁也逃不掉。'),
('978-7-5302-1756-6', '子夜', '茅盾', '北京十月文艺出版社', 38.00, NULL, 40, 3500, 1, '茅盾代表作，社会剖析小说', '/pictures/子夜.jpg', '天亮之前有一段时间是非常暗的。'),
('978-7-5442-4533-3', '黄金时代', '王小波', '上海译文出版社', 35.00, 45.00, 60, 8500, 1, '王小波代表作，自由与理性的呐喊', '/pictures/黄金时代.jpg', '一个人只拥有此生此世是不够的，他还应该拥有诗意的世界。'),
('978-7-5442-4534-0', '沉默的大多数', '王小波', '上海译文出版社', 32.00, 42.00, 55, 3000, 1, '王小波杂文集，独立思考的启蒙', '/pictures/沉默的大多数.jpg', '从话语中，你很少能学到人性，从沉默中却能。'),
('978-7-5402-3616-0', '杀死一只知更鸟', '哈珀·李', '人民文学出版社', 39.00, 49.00, 80, 17000, 1, '关于正义与勇气的成长小说', '/pictures/杀死一只知更鸟.jpg', '你永远不可能真正了解一个人，除非你从他的角度去看问题。'),
('978-7-5354-5424-9', '1984', '乔治·奥威尔', '南海出版公司', 42.00, 55.00, 70, 15000, 2, '反乌托邦经典，对极权主义的深刻洞察', '/pictures/1984.jpg', '战争即和平，自由即奴役，无知即力量。'),
('978-7-5442-4535-7', '霍乱时期的爱情', '加西亚·马尔克斯', '上海译文出版社', 49.00, 65.00, 65, 12000, 1, '马尔克斯爱情巨著', '/pictures/霍乱时期的爱情.jpg', '爱情首先是一种本能，要么生下来就会，要么永远都不会。');
